...
<head>
<meta charset="UTF-8">
<title>/cookie/loginform.jsp</title>
</head>
<body>
<h1>로그인폼1</h1>
...
<form action="login.jsp" method="post">
   <table>
      <tr>
         <th><label for="id">아이디</label></th>
         <td><input type="text" name="id" id="id" value="${cookie.savedId.value }"/></td>
      </tr>
      <tr>
         <th><label for="pwd">비밀번호</label></th>
         <td><input type="password" name="pwd" id="pwd" value="${cookie.savedPwd.value }"/></td>
      </tr>
      <tr>
         <td></td>
         <td>
